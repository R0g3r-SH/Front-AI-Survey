...
const RecommendationsD = () => {
  ...
  const generateAIRoadmap = async () => {
    ...
    if (selectedCompany === "todas") {
      console.error(
        "Please select a specific company to generate the roadmap."
      );
      return;
    }
    ...
    try {
      ...
      alert(
        "Ocurrió un error al generar el roadmap. Por favor, inténtalo de nuevo."
      );
    }
  };
  ...
  const generateAITraining = async () => {
    if (selectedCompany === "todas") {
      console.error(
        "Please select a specific company to generate the training."
      );
    ...
    if (roadmapData.roadmap_phases.length === 0) {
      toast.error(
    ...
    try {
      ...
      // Aquí podrías manejar el error, por ejemplo, mostrando un mensaje al usuario
      toast.error(
        "Ocurrió un error al generar el entrenamiento AI. Por favor, inténtalo de nuevo."
      );
    }
  };
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  ...
                  <div>
                    ...
                    <ul className="space-y-2 text-sm text-gray-600">
                      <li>
                        • Integración nativa entre todas las herramientas Google
                      </li>
                      <li>
